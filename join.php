...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                <a href="join.php" class="btn btn-danger btn-pills border-primary py-2 px-4 d-none d-lg-block">Join Us</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Kindly fill the bellow Form</h1>
    ...
    <!-- Contact Start -->
<div class="container-fluid d-flex justify-content-center align-items-start min-vh-100 " style="margin-top: -50px;">
        ...
        <div class="contact-form">
            <form action="user.php" method="POST">
                ...
                <div class="text-center">
                    <button class="btn btn-primary py-3 px-5" type="submit" name="join">Join Now</button>
                </div>
            </form>
        </div>
    </div>
